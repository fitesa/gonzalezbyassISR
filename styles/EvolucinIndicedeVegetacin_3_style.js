...
var style_EvolucinIndicedeVegetacin_3 = function(feature, resolution){
    ...
    if (value >= -0.302177 && value <= -0.206414) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.206414 && value <= -0.110651) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.110651 && value <= -0.014888) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.014888 && value <= 0.080875) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.080875 && value <= 0.176638) {
            style = [ new ol.style.Style({
