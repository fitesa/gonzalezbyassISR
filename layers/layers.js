...
var format_ViaGonzalezByass_5 = new ol.format.GeoJSON();
var features_ViaGonzalezByass_5 = format_ViaGonzalezByass_5.readFeatures(json_ViaGonzalezByass_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ViaGonzalezByass_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ViaGonzalezByass_5.addFeatures(features_ViaGonzalezByass_5);
var lyr_ViaGonzalezByass_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_ViaGonzalezByass_5, 
                style: style_ViaGonzalezByass_5,
                interactive: true,
    title: 'Viña Gonzalez Byass<br />\
    <img src="styles/legend/ViaGonzalezByass_5_0.png" /> T0 - TESTIGO<br />\
    <img src="styles/legend/ViaGonzalezByass_5_1.png" /> T1 - PROCROP ISR<br />'
        });

lyr_GoogleHybrid_0.setVisible(true);lyr_EvolucinIndicedeHumedad_1.setVisible(true);lyr_IndicedeHumedad_2.setVisible(true);lyr_EvolucinIndicedeVegetacin_3.setVisible(true);lyr_IndicedeVegetacin_4.setVisible(true);lyr_ViaGonzalezByass_5.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_EvolucinIndicedeHumedad_1,lyr_IndicedeHumedad_2,lyr_EvolucinIndicedeVegetacin_3,lyr_IndicedeVegetacin_4,lyr_ViaGonzalezByass_5];
...
lyr_ViaGonzalezByass_5.set('fieldAliases', {'ID': 'ID', 'TRATAMIENT': 'TRATAMIENT', });
...
lyr_ViaGonzalezByass_5.set('fieldImages', {'ID': 'TextEdit', 'TRATAMIENT': 'TextEdit', });
...
lyr_ViaGonzalezByass_5.set('fieldLabels', {'ID': 'header label', 'TRATAMIENT': 'header label', });
lyr_ViaGonzalezByass_5.on('precompose', function(evt) {
