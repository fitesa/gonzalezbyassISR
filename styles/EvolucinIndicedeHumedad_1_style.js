...
var style_EvolucinIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.180532 && value <= -0.112632) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.112632 && value <= -0.044733) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.044733 && value <= 0.023167) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.023167 && value <= 0.091066) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.091066 && value <= 0.158966) {
            style = [ new ol.style.Style({
