...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.080619 && value <= 0.179427) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.179427 && value <= 0.278235) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.278235 && value <= 0.377043) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.377043 && value <= 0.475851) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.475851 && value <= 0.574660) {
            style = [ new ol.style.Style({
