...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.174760 && value <= -0.107006) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.107006 && value <= -0.039251) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.039251 && value <= 0.028503) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.028503 && value <= 0.096258) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.096258 && value <= 0.164012) {
            style = [ new ol.style.Style({
